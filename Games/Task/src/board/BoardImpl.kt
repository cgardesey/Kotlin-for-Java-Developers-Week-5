...
fun createSquareBoard(width: Int): SquareBoard = MySquareBoardImpl(width)
fun <T> createGameBoard(width: Int): GameBoard<T> = MyGameBoardImpl<T>(width)

open class MySquareBoardImpl(final override val width: Int) : SquareBoard{
...
class MyGameBoardImpl<T>(width: Int) : MySquareBoardImpl(width), GameBoard<T> {
